...
export default function FullGallerySection({ initialWorks }: FullGallerySectionProps) {
  return (
    <section
      id="full-gallery"
      className="relative w-full bg-black text-white pt-16 sm:pt-24 md:pt-32 pb-14 sm:pb-20 md:pb-28 z-30 overflow-hidden"
    >
      <div className="w-full flex flex-col gap-8 sm:gap-14">
        
        {/* Section Header */}
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-12 md:px-20 lg:px-32 flex flex-col gap-4 sm:gap-5">
          ...
          <p className="text-sm sm:text-base md:text-lg text-neutral-400 font-light leading-relaxed max-w-2xl">
            An expansive 3D perspective wall exhibiting the full photographer archive. Tilt or move across the field, and click or tap any frame to bring it to the front.
          </p>
        </div>
